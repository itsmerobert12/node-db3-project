...
async function find() { // EXERCISE A
  ...
  */
    ...
    const table = await db('schemes as sc')
...
async function findById(scheme_id) { // EXERCISE B
  ...
  */
      ...
      const newArray = {
        ...
        steps: data.reduce((posts, post) => {
          if (!post.step_id) return posts
          const { step_id, step_number, instructions } = post
          return posts.concat({ step_id, step_number, instructions })
        }, []),
      }
      return newArray;
}
